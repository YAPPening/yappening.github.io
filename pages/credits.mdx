...
- **Natan Shapiro**: For doing beta testing and providing UI design choices. 
...
- **Dependabot**: GitHub's dependency security bot (its basically sentient right?), for doing package scans to find common vulnerabilities and exploits.

We are immensly grateful for you support!
